/*Fetching the id so that we will add the event listner to it*/
const searchBox = document.getElementById("search-box");
const searchList = document.getElementById("instant-search__list");
const heroDetails = document.getElementById("hero-details");

/*Adding Event Listner To that search box on keyup event*/
let delay;
searchBox.addEventListener('keyup', (event) => {
    ...
    delay = setTimeout(() => {
        ...
        if (str.length >= 1) {
            ...
            xhr.open('GET', `https://www.superheroapi.com/api.php/3105140062907191/search/${str}`, true);
            xhr.onload = () => {
